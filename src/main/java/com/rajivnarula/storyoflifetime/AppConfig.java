...
public class AppConfig {
    ...
    private final String factGeneratorModel;
    private final double factGeneratorTemperature;
    ...
    public AppConfig() throws IOException {
        ...
        this.factGeneratorTemperature = Double.parseDouble(props.getProperty("factgenerator.temperature", "0.9"));
    ...
    public String getFactGeneratorModel()         { return factGeneratorModel; }
    public double getFactGeneratorTemperature()   { return factGeneratorTemperature; }
